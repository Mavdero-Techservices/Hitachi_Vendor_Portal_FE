          ...
          <Col sm={8}>
            ...
            <MDBRow className="mb-4">
              <MDBCol>
                ...
                <div>
                  <input type={passwordType} className="mb-4 signupInput" name="password" id="password" onChange={formValChange('password')} value={values.password} />
                  <VisibilityIcon
                        style={{
                          position: "absolute",
                          right: "10%",
              ...
              <MDBCol>
                ...
                <input type={ConfirmPasswordType} className="mb-4 signupInput" name="confirmPassword" id="confirmPassword" onChange={formValChange('confirmPassword')} value={values.confirmPassword} />
                <VisibilityIcon
